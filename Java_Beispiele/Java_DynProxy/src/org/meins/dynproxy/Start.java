...
/**
 * This start class shows the use of the dynamic proxy standard class in the JRE
 * libraries. It is a simple but effective means to provide something like
 * aspects or interceptor logic wrapped around the execution of the methods of
 * an arbitrary business object.
 *
