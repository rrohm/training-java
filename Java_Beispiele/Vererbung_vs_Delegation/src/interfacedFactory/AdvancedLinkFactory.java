 ...
 * eine Instanz des anderen Typs deligieren.
 *
 * @author Robert Rohm&lt;r.rohm@aeonium-systems.de&gt;
 */
public class AdvancedLinkFactory implements LinkFactory {

  private final BaseLinkFactory factory;

  /**
   * Mit Konstruktor wird eine Referenz auf die factory übergeben, and die
   * deligiert werden soll (vgl. "Constructor Injection"):
   */
  ...
  /**
   * Hier wird die Ausführung der Methode an den "delegate" deligiert.
   * @param id
   * @return
   */
  @Override
