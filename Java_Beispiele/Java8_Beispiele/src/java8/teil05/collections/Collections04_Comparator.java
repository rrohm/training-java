...
public class Collections04_Comparator {
  ...
  public static void main(String[] args) {
    ...
    persons.sort(new Comparator<Person>() {
      /**
       * compare() soll qua Konvention nur 3 Werte liefern: -1 für "kleiner", 0
       * für "gleich, im Sinne von equals()", 1 für "größer".
       *
       * @param person1
       * @param person2
   ...
   * Lambda-Ausdrucks eingesetz werden soll. Nebenbei: Der Methodennamen aus dem
   * Comparator-Interface muss hier nicht mehr beibehalten werden (s.
   * Typ-Inferenz und Target-Typing).
   *
   * @param person1
   * @param person2
   * @return
