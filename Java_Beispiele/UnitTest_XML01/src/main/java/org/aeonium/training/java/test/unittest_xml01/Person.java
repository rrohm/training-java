...
public class Person {
	...
	/**
	 * Eigene Implementierung, für fachlich orientierten Vergleich 
	 * zweier Person-Instanzen abgewandelt. 
	 * 
  ...
  /**
   * Custom hashcode, based on the contract that if o1.equals(o2) is true, 
