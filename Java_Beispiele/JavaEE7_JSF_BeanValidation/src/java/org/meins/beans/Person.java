...
public class Person {
  ...
  @Size(min = 2, max = 30, message = "Name muss mindestens 2, höchtens 30 Zeichen lang sein ")
  private String name;

  @Size(min = 2, max = 30, message = "Vorname muss mindestens 2, höchtens 30 Zeichen lang sein ")
