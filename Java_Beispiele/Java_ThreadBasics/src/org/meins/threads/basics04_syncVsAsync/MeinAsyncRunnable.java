...
/**
 * <b>GANZ SCHLECHT:</b> Runnable, das auf ein gemeinsam genutztes Objekt ohne
 * Synchronisierung schreibend und lesend zugreift, daher "AsyncRunnable".
 *
 * @author Robert Rohm
 */
public class MeinAsyncRunnable implements Runnable {

  private int counter = 0;

  private final MeinObjekt lock;

  public MeinAsyncRunnable(MeinObjekt lock) {
    this.lock = lock;
  }
