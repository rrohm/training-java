 ...
 */
public class BerechnungsClient1 {
...
//    System.getProperties().setProperty("java.security.policy", "policy");
    ...
    // Das geht:
    System.getProperties().setProperty("java.rmi.server.codebase", "file:R:/AEONIUM/WORK-ONLINE/aeJavaTraining/work/Java7_RMIServer/dist/Java7_RMIServer.jar");
    try {
