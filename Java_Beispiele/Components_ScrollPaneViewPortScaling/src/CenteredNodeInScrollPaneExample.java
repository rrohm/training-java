...
/**
 * Example of centering a various kinds of nodes in a scrollpane applying
 * effects and transforms to them and reporting changes in their various bounds
 * types.
 *
 * https://gist.github.com/jewelsea/1442298
 * http://stackoverflow.com/questions/12394213/scaling-in-javafx-and-scrollpanes
 */
...
// add starting data
  ...
  private void reportBounds(final Node n) {
    ...
    if (stroke.isSelected()) {
      description.append("Stroke 10 : ");
    }
    if (effect.isSelected()) {
      description.append("Dropshadow Effect : ");
    }
    if (translate.isSelected()) {
      description.append("Translated : ");
    }
    if (rotate.isSelected()) {
      description.append("Rotated 45 degrees : ");
    }
    if (scale.isSelected()) {
      description.append("Scale 3 : ");
    }
    if (description.length() == 0) {
      description.append("Unchanged : ");
    }
